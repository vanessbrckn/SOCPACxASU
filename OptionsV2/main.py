...
def main():
    ...
    main.addLayout(add_options_v2.question_list_UI(question_list))

    print_btn = QPushButton("print")

    printed_layout = QVBoxLayout()

    print_btn.clicked.connect(lambda: print_questions(printed_layout, question_list))
    main.addWidget(QWidget())
    main.addWidget(print_btn)
    main.addLayout(printed_layout)
